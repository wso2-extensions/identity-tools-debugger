...
/**
 * Encode the translated the OIDCAuthzResponse variable.
 */
public class OIDCAuthzResponseEncoder implements VariableEncoder {

    @Override
    public JsonObject translate(Object oidcAuthzResponseTranslated) {

        JsonObject arrayElement = new JsonObject();
        arrayElement.addProperty(DAPConstants.JSON_KEY_FOR_TYPE, DAPConstants.VARIABLE_TYPE_STRING);
        arrayElement.addProperty(DAPConstants.JSON_KEY_FOR_VALUE, (String) oidcAuthzResponseTranslated);
